...
def _preprocess(merged_df, path=None):
...
class ROUGEModelLoader():
    ...
    def preprocess(self):
        self.summaries_processed = _preprocess(self.summaries, self.data_path)
...
if __name__ == '__main__':
    preprocessed_data_path = '../data/merged_rouge_preprocessed.csv'

    merged_df = pd.read_csv('../data/merged.csv')

    _preprocess(merged_df, preprocessed_data_path)
    ...
    model_loader.data_path = preprocessed_data_path
